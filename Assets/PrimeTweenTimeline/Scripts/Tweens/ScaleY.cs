...
{
    [Serializable]
    public class ScaleY : TweenTrack<float>
    {
        ...
        public override Sequence Create(ref Sequence sequence, GameObject self)
        {
            ...
            if (!hasStartValue && Mathf.Approximately(cachedTarget.localScale.y, end)) return sequence;
            ...
            if (hasStartValue)
            {
                cachedTarget.localScale =
                    new Vector3(cachedTarget.localScale.x, start, cachedTarget.localScale.z);
            }

            sequence.Group(Tween.ScaleY(cachedTarget, settings));
        ...
        protected override void PickStart()
        {
            ...
            if (cachedTarget)
            {
                ...
                start = cachedTarget.localScale.y;
            }
#endif
        }
        ...
        protected override void GoToStart()
        {
            ...
            if (cachedTarget)
            {
                ...
                cachedTarget.localScale = new Vector3(cachedTarget.localScale.x, start, cachedTarget.localScale.z);
            }
#endif
        }
        ...
        protected override void GoToEnd()
        {
            ...
            if (cachedTarget)
            {
                ...
                cachedTarget.localScale = new Vector3(cachedTarget.localScale.x, end, cachedTarget.localScale.z);
            }
#endif
        }
    }
